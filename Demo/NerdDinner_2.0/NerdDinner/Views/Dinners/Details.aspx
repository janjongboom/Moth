...
<asp:Content ID="details" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="dinnerDiv" class="vevent">
        ...
        <a href="http://twitter.com/home/?source=nerddinner&status=Nerd+Dinner%3A+<%: Model.Title.Truncate(40) %>+on+<%: Model.EventDate.ToString("MMM dd") %>+-+RSVP%3A+http%3A%2F%2Fnrddnr.com/<%: Model.DinnerID %>"  
            ...
            <img src="<%=ResolveUrl("~/Content/Img/icon-twitter.png") %>" alt="Twitter" border="0" />
        </a><a href="http://www.facebook.com/share.php?u=http%3A%2F%2Fnrddnr.com/<%: Model.DinnerID %>"  
            title="Add to Facebook" target="_blank">
            <img src="<%=ResolveUrl("~/Content/Img/icon-facebook.png")%>" alt="Facebook" border="0" />
            ...
            <img src="<%=ResolveUrl("~/Content/Img/icon-google.png")%>" alt="Google Buzz" border="0" />
        ...
        <p>
            ...
            <a href="<%:Url.Action("iCal","Services", new { id = Model.DinnerID }, null) %>"><img src="<%=ResolveUrl("~/Content/Img/icon-icalfeed-16x16.png")%>" /></a>
        </p>
    ...
    <div id="mapDiv">
        ...
        <p>
             <img src="<%=ResolveUrl("~/content/img/microformat_hcalendar.png") %>" alt="hCalendar"/>
        </p>
    </div>  
