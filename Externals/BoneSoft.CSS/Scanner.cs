	...
	public class Scanner {
		...
		Token NextToken() {
			...
			switch (state) {
				...
				case 36:
					if (ch == 'i') { AddCh(); goto case 37; } else { t.kind = noSym; break; }
				case 37:
					if (ch == 'm') { AddCh(); goto case 38; } else { t.kind = noSym; break; }
				case 38:
					if (ch == 'p') { AddCh(); goto case 39; } else { t.kind = noSym; break; }
				case 39:
					if (ch == 'o') { AddCh(); goto case 40; } else { t.kind = noSym; break; }
				case 40:
					if (ch == 'r') { AddCh(); goto case 41; } else { t.kind = noSym; break; }
				case 41:
					if (ch == 't') { AddCh(); goto case 42; } else { t.kind = noSym; break; }
				case 42:
					if (ch == 'a') { AddCh(); goto case 43; } else { t.kind = noSym; break; }
				case 43:
					if (ch == 'n') { AddCh(); goto case 44; } else { t.kind = noSym; break; }
				case 44:
					if (ch == 't') { AddCh(); goto case 45; } else { t.kind = noSym; break; }
				case 45: { t.kind = 44; break; }
				case 46: { t.kind = 45; break; }
				case 47: { t.kind = 46; break; }
				case 48: { t.kind = 47; break; }
				case 49:
				...
				case 52:
					if (ch == '-' || ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 'z') { AddCh(); goto case 1; } else if (ch == 92) { AddCh(); goto case 47; } else { t.kind = 1; t.val = new String(tval, 0, tlen); CheckLiteral(); return t; }
